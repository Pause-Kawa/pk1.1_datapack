...
scoreboard players operation %PKT_RNG_2 value = %PKT_randomizer_seed value
scoreboard players operation %PKT_RNG_2 value /= %PKT_const_100 value
scoreboard players operation %PKT_RNG_2 value %= %PKT_randomizer_max value